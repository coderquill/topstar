    ...
    return (
        <Box borderWidth={1} bg='white' p='15px' rounded='5px'>
            <Flex mb='15px'>
                ...
                />
                <Box ml='10px'>
                    <Heading fontSize='16px'>Rupali Kavale</Heading>
                    <Text fontSize='13px'>View profile</Text>
                </Box>
            </Flex>
            <Box mb='15px'>
                <Box mb='18px'>
                    <Heading fontSize='19px' as='a' href='https://github.com/coderquill/githunt' target='_blank' color='purple.700'>GitHunt</Heading>
                    <Text fontSize='14px' color='gray.600'>Built by &middot;<Link href='https://github.com/coderquill/githunt' target='_blank' >Rupali Kavale</Link>&middot; 17 July, 2020</Text>
                </Box>
                <Text fontSize='14px' color='gray.900'>Hunt the most starred repositories on github</Text>
            </Box>

            <Stack isInline>
            <Button as = 'a' cursor='pointer' leftIcon ='star' variant ='link' fontSize='14px'_hover={{textDecoration:'none'}} iconSpacing='4px' >9834</Button>
            <Button as = 'a' cursor='pointer' leftIcon ={GoRepoForked} variant ='link' fontSize='14px'_hover={{textDecoration:'none'}} iconSpacing='4px' >94</Button>
            <Button as = 'a' cursor='pointer' leftIcon ={GoIssueOpened} variant ='link' fontSize='14px'_hover={{textDecoration:'none'}} iconSpacing='4px' >33</Button>
            </Stack>
