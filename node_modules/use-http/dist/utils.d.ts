...
export declare const remove: (val: any) => {
    from: (arr: any[]) => void;
};
/**
...
export declare const tryGetData: (res: Response | undefined, initialData: any, responseType: ResponseType) => Promise<any>;
/**
...
export declare const makeError: (name: import("react").ReactText, message: string) => Error;
/**
